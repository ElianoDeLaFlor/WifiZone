                                            ...
                                            <form method="POST" action="traitement/php/traitementDemandeClient.php" id="connexion_client">
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <div class="font-weight-bold">Modification de mot de passe :</span></div>
                                                        <input type="hidden" name="mdpChange" value="">
                                                        <input type="password" class="form-control rounded-0 border-0 font-weight-bold my-1" id="id_mdp_client" name="MdpClient" placeholder="Nouveau mot de passe" required="required">
                                                        <input type="password" class="form-control rounded-0 border-0 font-weight-bold" id="id_conf_mdp_client" placeholder="Confirmez le nouveau mot de passe" required="required">
                                                    </div>
                                                </div>
